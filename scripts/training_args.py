...
COMMON_ARGS = {
    ...
    "dataset_name": ArgumentDefinition(
        name="dataset_name",
        arg_type=str,
        default=None,
        choices=[
        ...
        help_text="Specific dataset to use (if not specified, auto-detects from data_dir)",
    ),
    "dataset_subset": ArgumentDefinition(
        name="dataset_subset",
        arg_type=str,
        default="all",
        choices=["top-1000", "top-3000", "all"],
        help_text="Subset for MegaHan97K (ignored for other datasets)",
    ),
